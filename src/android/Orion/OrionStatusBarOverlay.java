...
public class OrionStatusBarOverlay extends ViewGroup {
    public OrionStatusBarOverlay(Context context) {
        super(context);
    }
    ...
    public static void add(Activity activity) {
        ...
        OrionStatusBarOverlay view = new OrionStatusBarOverlay(activity);
